                ...
                {filteredClients.map((client) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h3 className="text-lg font-semibold text-foreground group-hover:text-blue-600 transition-colors">{client.name}</h3>
                              {client.gender && (
                      ...
                      <div className="px-6 py-4 bg-gray-50 border-t border-border flex items-center gap-3">
                        <button
                  ...
                  return (
                    <div key={client.id} className="bg-card text-foreground overflow-hidden p-4 rounded-lg shadow-sm border border-border flex flex-col">
                      <div className="flex-grow">
                        ...
                        {client.notes && (
                          <p className="text-sm text-muted-foreground mt-2 pt-2 border-t border-gray-100 italic">"{client.notes}"</p>
                        )}
                      </div>
