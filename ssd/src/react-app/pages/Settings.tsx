                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-5 rounded-xl border border-blue-200">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      type="time"
                      id="applyStartTime"
                      className="border-border rounded-lg shadow-sm focus:ring-ring focus:border-ring text-sm px-3 py-2 bg-background text-foreground placeholder:text-muted-foreground"
                    />
                  ...
                  <div className="bg-card px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div className="space-y-4">
                       <div>
                        ...
                        <input type="date" {...registerException('exception_date', { required: 'Data é obrigatória' })} className="mt-1 block w-full border-border rounded-md shadow-sm focus:ring-ring focus:border-ring sm:text-sm bg-background text-foreground placeholder:text-muted-foreground" />
                      ...
                      <div>
                        ...
                        <input type="text" {...registerException('description', { required: 'Descrição é obrigatória' })} placeholder="Ex: Feriado Nacional" className="mt-1 block w-full border-border rounded-md shadow-sm focus:ring-ring focus:border-ring sm:text-sm bg-background text-foreground placeholder:text-muted-foreground" />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input type="time" {...registerException('start_time')} className="mt-1 block w-full border-border rounded-md shadow-sm focus:ring-ring focus:border-ring sm:text-sm bg-background text-foreground placeholder:text-muted-foreground" />
                        ...
                        <div>
                          ...
                          <input type="time" {...registerException('end_time')} className="mt-1 block w-full border-border rounded-md shadow-sm focus:ring-ring focus:border-ring sm:text-sm bg-background text-foreground placeholder:text-muted-foreground" />
                        </div>
                      </div>
                    </div>
                  </div>
