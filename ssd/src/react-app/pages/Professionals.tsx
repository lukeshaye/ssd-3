        ...
        <div className="mt-8">
          {professionals.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Nenhum profissional cadastrado</h3>
...
function ProfessionalCard({ professional, onEdit, onDelete }: ProfessionalCardProps) {
  ...
  return (
    <div className="group bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-pink-200 transition-all duration-200 overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="flex items-center mb-1">
              ...
              <span className="text-xs font-medium text-gray-600">Salário Base</span>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="flex items-center mb-1">
              <TrendingUp className="w-4 h-4 text-violet-600 mr-1" />
              <span className="text-xs font-medium text-gray-600">Comissão</span>
            </div>
            <p className="text-sm font-semibold text-gray-900">
        ...
        <Link 
          ...
          className="block w-full bg-gradient-to-r from-pink-500 to-violet-500 text-white text-center py-2.5 rounded-lg font-medium hover:from-pink-600 hover:to-violet-600 transition-all duration-200 shadow-sm hover:shadow-md"
        >
          Ver Detalhes
        </Link>
      </div>
